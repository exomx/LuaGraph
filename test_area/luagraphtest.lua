...
tabletest4 = {x=0,y=300,w=100,h=100, r=0,g=1,b=0, texture=santa_hat}
...
fonttexture = lua_graph.generate_fonttexture(font, "wofsdffffffs")
tabletest9 = {x=400, y=150,w=100,h=100,r=1,g=1,b=1,texture=fonttexture}
